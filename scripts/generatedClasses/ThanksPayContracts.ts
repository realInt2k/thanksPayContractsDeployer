...
export class ThanksPayMain extends ThanksPayContracts {
  ...
  public method = {
    ...
    authorize: async (args: ThanksPaySuperType["thanksPayMain"]["authorize"]):Promise<any> => {
      const receipt = await this.sendTx("authorize", args);
      return receipt;
    },

    checkAuthorized: async (args: ThanksPaySuperType["thanksPayMain"]["checkAuthorized"]):Promise<any> => {
      const receipt = await this.sendTx("checkAuthorized", args);
      return receipt;
    },
    ...
    recallAuthorization: async (args: ThanksPaySuperType["thanksPayMain"]["recallAuthorization"]):Promise<any> => {
      const receipt = await this.sendTx("recallAuthorization", args);
      return receipt;
    },
...
export class ThanksPayData extends ThanksPayContracts {
  ...
  public method = {
    ...
    authorize: async (args: ThanksPaySuperType["thanksPayData"]["authorize"]):Promise<any> => {
      const receipt = await this.sendTx("authorize", args);
      return receipt;
    },

    checkAuthorized: async (args: ThanksPaySuperType["thanksPayData"]["checkAuthorized"]):Promise<any> => {
      const receipt = await this.sendTx("checkAuthorized", args);
      return receipt;
    },
    ...
    recallAuthorization: async (args: ThanksPaySuperType["thanksPayData"]["recallAuthorization"]):Promise<any> => {
      const receipt = await this.sendTx("recallAuthorization", args);
      return receipt;
    },
    ...
    revertCheck: async (args: ThanksPaySuperType["thanksPayData"]["revertCheck"]):Promise<any> => {
      const receipt = await this.sendTx("revertCheck", args);
      return receipt;
    },
...
export class ThanksPaySecurity extends ThanksPayContracts {
  ...
  public method = {
    ...
    authorizeContracts: async (args: ThanksPaySuperType["thanksPaySecurity"]["authorizeContracts"]):Promise<any> => {
      const receipt = await this.sendTx("authorizeContracts", args);
      return receipt;
    },

    authorizePeople: async (args: ThanksPaySuperType["thanksPaySecurity"]["authorizePeople"]):Promise<any> => {
      const receipt = await this.sendTx("authorizePeople", args);
      return receipt;
    },

    cancelAuthorization: async (args: ThanksPaySuperType["thanksPaySecurity"]["cancelAuthorization"]):Promise<any> => {
      const receipt = await this.sendTx("cancelAuthorization", args);
      return receipt;
    },

    getAuthorizedContracts: async (args: ThanksPaySuperType["thanksPaySecurity"]["getAuthorizedContracts"]):Promise<any> => {
      const receipt = await this.sendTx("getAuthorizedContracts", args);
      return receipt;
    },

    getAuthorizedHuman: async (args: ThanksPaySuperType["thanksPaySecurity"]["getAuthorizedHuman"]):Promise<any> => {
      const receipt = await this.sendTx("getAuthorizedHuman", args);
      return receipt;
    },
    ...
    isPersonOrContract: async (args: ThanksPaySuperType["thanksPaySecurity"]["isPersonOrContract"]):Promise<any> => {
      const receipt = await this.sendTx("isPersonOrContract", args);
      return receipt;
    },
...
export class ThanksPayRelay extends ThanksPayContracts {
  ...
  public method = {
    ...
    authorize: async (args: ThanksPaySuperType["thanksPayRelay"]["authorize"]):Promise<any> => {
      const receipt = await this.sendTx("authorize", args);
      return receipt;
    },

    checkAuthorized: async (args: ThanksPaySuperType["thanksPayRelay"]["checkAuthorized"]):Promise<any> => {
      const receipt = await this.sendTx("checkAuthorized", args);
      return receipt;
    },
    ...
    recallAuthorization: async (args: ThanksPaySuperType["thanksPayRelay"]["recallAuthorization"]):Promise<any> => {
      const receipt = await this.sendTx("recallAuthorization", args);
      return receipt;
    },

    revertCheck: async (args: ThanksPaySuperType["thanksPayRelay"]["revertCheck"]):Promise<any> => {
      const receipt = await this.sendTx("revertCheck", args);
      return receipt;
    },
...
export class ThanksPayCheck extends ThanksPayContracts {
  ...
  public method = {
    ...
    authorize: async (args: ThanksPaySuperType["thanksPayCheck"]["authorize"]):Promise<any> => {
      const receipt = await this.sendTx("authorize", args);
      return receipt;
    },

    checkAuthorized: async (args: ThanksPaySuperType["thanksPayCheck"]["checkAuthorized"]):Promise<any> => {
      const receipt = await this.sendTx("checkAuthorized", args);
      return receipt;
    },
    ...
    recallAuthorization: async (args: ThanksPaySuperType["thanksPayCheck"]["recallAuthorization"]):Promise<any> => {
      const receipt = await this.sendTx("recallAuthorization", args);
      return receipt;
    },
    ...
    revertCheck: async (args: ThanksPaySuperType["thanksPayCheck"]["revertCheck"]):Promise<any> => {
      const receipt = await this.sendTx("revertCheck", args);
      return receipt;
    },
